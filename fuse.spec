...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'modules.issues_log', 'modules.machine_id', 'modules.ai_tools', 'modules.account',
        'gui.panels.bus_monitor_panel', 'gui.panels.account_panel',
        'gui.auth_dialog', 'gui.change_password_dialog',
        ...
        'gui', 'gui.theme', 'gui.qt_helpers', 'gui.panels',
        'gui.panels.connection', 'gui.panels.scanner_panel',
        'gui.panels.dtc_panel', 'gui.panels.pats_panel',
        'gui.panels.asbuilt_panel', 'gui.panels.monitor_panel',
        'gui.panels.security_panel', 'gui.main_window',
        'gui.ai_mechanic_window',
