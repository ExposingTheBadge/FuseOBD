...
STANDARD_PIDS: list[PIDDefinition] = [
    ...
    PIDDefinition(0xF406, "Short Term Fuel Trim", "%", "PCM", -100, 99.2, bytes_count=1, scale=100/128, offset=-100),
    PIDDefinition(0xF407, "Long Term Fuel Trim", "%", "PCM", -100, 99.2, bytes_count=1, scale=100/128, offset=-100),
